              ...
              <div className="card">
                ...
                <div className="card__information">
                  <div className="information-column">
                    ...
                    <p className="column-detail">
                      {replacePlaceholders("{alternative_contact_number}", decodedToken)}
                    </p>
                  </div>
                </div>
                ...
                <div className="card__information">
                  <div className="information-column">
                    <h3 className="column-heading">Communication Address</h3>
                    <p className="column-detail">
                      {replacePlaceholders("{communication_address}", decodedToken)}
                    </p>
                  </div>
                </div>
              </div>
