...
const ResetPassword = () => {
    ...
    const handlePasswordChange = (field, value) => {
        ...
        setPasswordsMatch(field === 'newPassword'
            ...
            <div className="reset_container">
                <div className="reset_glass">
                    <div className="reset_title">
                        <h4 className="reset_heading">Reset Password  🔄</h4>
                        <span className='reset_subheading'>Don't worry! We're here to help you regain control of your account.</span>
                    </div>
                    ...
                    <div className="reset_form">
                        ...
                        <div className="reset_password_input">
                            <input
                                ...
                                className={`reset_textbox ${passwordsMatch ? '' : 'password-error'}`}
                                placeholder='Set New Password'
                                value={newPassword}
                                onChange={(e) => handlePasswordChange('newPassword', e.target.value)}
                            />
                            {/* Eye-toggle icon to show/hide the new password */}
                            <span className="reset_eye_toggle" onClick={() => handleTogglePasswordVisibility('showPassword')}>
                        ...
                        <div className="reset_password_input">
                            ...
                            <span className="reset_eye_toggle" onClick={() => handleTogglePasswordVisibility('showConfirmPassword')}>
                        ...
                        {!passwordsMatch && confirmPassword && (
                            <div className="reset_error_message">
                        ...
                        {passwordsMatch && confirmPassword && (
                            <div className="reset_success_message">
                                Passwords match
                            </div>
                        )}

                        {/* Button to confirm the password reset */}
                        <button className='reset_button' disabled={isButtonDisabled} onClick={handleResetPassword}>
